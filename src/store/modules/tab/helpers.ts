...
/**
 * @description 根据vue路由获取tab路由
 * @param { RouteRecordNormalized | RouteLocationNormalizedLoaded } route
 */
 ...
 * @param { App.GlobalTabRoute[] } tabs - 多页签数据
 * @param { string } fullPath - 该页签的路径
 */
...
/**
 * @description 判断路由是否有fullPath属性
 * @param { RouteRecordNormalized | RouteLocationNormalizedLoaded } route 路由
 */
