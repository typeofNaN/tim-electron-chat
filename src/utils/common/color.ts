 ...
 * @param { AnyColor } color - 颜色
 * @param { ColorIndex } index - 调色板的对应的色号(6为主色号)
 * @returns 返回hex格式的颜色
 */
 ...
 * @param { AnyColor } color - 颜色
 * @param { boolean } darkTheme - 暗黑主题的调色板颜色
 * @param { string } darkThemeMixColor - 暗黑主题的混合颜色，默认 #141414
 */
...
/**
 * @description 获取色相渐变
 * @param { HsvColor } hsv - hsv格式颜色值
 * @param { number } i - 与6的相对距离
 * @param { boolean } isLight - 是否是亮颜色
 */
