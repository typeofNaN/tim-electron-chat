/**
 * @description 获取面包屑数据
 * @param { string } activeKey - 当前页面路由的key
 * @param { App.GlobalMenuOption[] } menus - 菜单数据
 * @param { string } rootPath - 根路由路径
 */
...
/**
 * @description 根据单个菜单数据获取面包屑格式的菜单
 * @param { string } activeKey - 当前页面路由的key
 * @param { App.GlobalMenuOption[] } menu - 单个菜单数据
 */
...
/**
 * @description 将面包屑格式的菜单数据转换成面包屑数据
 * @param { App.GlobalMenuOption[] } menu - 单个菜单数据
 * @param { string } rootPath - 根路由路径
 */
